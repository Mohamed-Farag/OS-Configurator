...
class CreateArxml:
    ...
    def AddTask(self, tasklist):
        ...
        ECUC_ENUMERATION_PARAM = ET.SubElement(PARAMETERS, "ECUC-TEXTUAL-PARAM-VALUE")
        taskautostart = ET.SubElement(ECUC_ENUMERATION_PARAM, "SHORT-NAME")
        taskautostart.text = "OsTaskAutostart"
        ...
        if Value_OsTaskType.text == "EXTENDED":
            REFERENCE_VALUES = ET.SubElement(cont1_for_name, "REFERENCE-VALUES")

            # OsTaskEventRef#
            for i in range(tasklist[7]):
                if tasklist[9][i] != 'Null':
            ...
            # OsTaskResourceRef#
            for i in range(tasklist[8]):
                if tasklist[10][i] != 'Null':
                    ECUC_REFERENCE_VALUE = ET.SubElement(REFERENCE_VALUES, "ECUC-REFERENCE-VALUE")
    ...
    def AddAlarm(self, alarmtable):
        ...
        ECUC_INTEGER_PARAM_VALUE = ET.SubElement(PARAMETERS, "ECUC-NUMERICAL-PARAM-VALUE")
        alarmtype = ET.SubElement(ECUC_INTEGER_PARAM_VALUE, "SHORT-NAME")
        alarmtype.text = "Alarm Time"
        Value_alarmtype = ET.SubElement(ECUC_INTEGER_PARAM_VALUE, "VALUE")
        Value_alarmtype.text = str(alarmtable[2])

        # OsAlarmCycleTime
        ECUC_INTEGER_PARAM_VALUE = ET.SubElement(PARAMETERS, "ECUC-NUMERICAL-PARAM-VALUE")
        alarmtype = ET.SubElement(ECUC_INTEGER_PARAM_VALUE, "SHORT-NAME")
        alarmtype.text = "Cycle Time"
        Value_alarmtype = ET.SubElement(ECUC_INTEGER_PARAM_VALUE, "VALUE")
        Value_alarmtype.text = str(alarmtable[3])
        ...
        Value_OsAlarmCallbackName.text = str(alarmtable[6])
    ...
    def AddISR(self, isrtable):
        ...
        ECUC_NUMERICAL_PARAM = ET.SubElement(PARAMETERS, "ECUC-TEXTUAL-PARAM")
                                    ...
                                    if gchild2.tag == "{http://autosar.org/schema/r4.0}ECUC-REFERENCE-VALUE":
                                        for ggchild2 in gchild2:
                                            if ggchild2.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                if ggchild2.text == "OsTaskEventRef":
                                                    flag = 1
                                                if ggchild2.text == "OsTaskResourceRef":
                                                    flag = 2
                                            elif ggchild2.tag == "{http://autosar.org/schema/r4.0}VALUE-REF":
                                                if flag == 1:
                                                    EventCounterRef = EventCounterRef + 1
                                                    EV_ref_temp.append(ggchild2.text[79:-1])
                                                if flag == 2:
                                                    ResourceCounterRef = ResourceCounterRef + 1
                                                    RES_ref_temp.append(ggchild2.text[79:-1])

                        Tasklist.append(Tasklist_temp)

                        Taskvalues_temp.append(EventCounterRef)
                        Taskvalues_temp.append(ResourceCounterRef)
                        Taskvalues_temp.append(EV_ref_temp)
                        Taskvalues_temp.append(RES_ref_temp)

                        Taskvalues.append(Taskvalues_temp)

        return Tasklist, Taskvalues
                                        ...
                                        if gchild2.tag == "{http://autosar.org/schema/r4.0}ECUC-REFERENCE-VALUE":
                                            for ggchild2 in gchild2:
                                                if ggchild2.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                    ...
                                                    Alarmvalues_temp.append(ggchild2.text[79:-1])
                                            ...
                                            for gchild3 in child3:
                                                if gchild3.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                                        ...
                                                                        if ggggchild3.tag == "{http://autosar.org/schema/r4.0}ECUC-REFERENCE-VALUE":
                                                                            for gggggchild3 in ggggchild3:
                                                                                if gggggchild3.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                                                    Alarmlist_temp.append(
                                                                                        gggggchild3.text)
                                                                                elif gggggchild3.tag == "{http://autosar.org/schema/r4.0}VALUE-REF":
                                                                                    Alarmvalues_temp.append(
                                                                                        gggggchild3.text[79:-1])
                                                    for ggchild3 in gchild3:
                                                        if ggchild3.tag == "{http://autosar.org/schema/r4.0}ECUC-CONTAINER-VALUE":
                                                            for gggchild3 in ggchild3:
                                                                if gggchild3.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                    ...
                                                    for ggchild3 in gchild3:
                                                        ...
                                                        elif ggchild3.tag == "{http://autosar.org/schema/r4.0}REFERENCE-VALUES":
                                                            for gggchild3 in ggchild3:
                                                                if gggchild3.tag == "{http://autosar.org/schema/r4.0}ECUC-REFERENCE-VALUE":
                                                                    for ggggchild3 in gggchild3:
                                                                        if ggggchild3.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME" and "OsAlarmSetEventRef" in ggggggchild3.text:
                                                                            Alarmlist_temp.append(gggchild3.text)
                                                                        elif gggggchild3.tag == "{http://autosar.org/schema/r4.0}VALUE-REF":
                                                                            Alarmvalues_temp.append(ggggchild3.text[79:-1])
                                                                    for gggggchild3 in ggggchild3:
                                                                        if gggggchild3.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME" and "OsAlarmSetEventTaskRef" in ggggggchild3.text:
                                                                            Alarmlist_temp.append(ggggchild3.text)
                                                                        elif gggggchild3.tag == "{http://autosar.org/schema/r4.0}VALUE-REF":
                                                                            Alarmvalues_temp.append(gggggchild3.text[79:-1])
                ...
                for child1 in node:
                    if child1.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME" and "OsISR" in child1.text:
                        ...
                        for child2 in node:
                            ...
                            if child2.tag == "{http://autosar.org/schema/r4.0}REFERENCE-VALUES":
                                for gchild2 in child2:
                                    if gchild2.tag == "{http://autosar.org/schema/r4.0}ECUC-REFERENCE-VALUE":
                                        for ggchild2 in gchild2:
                                            if ggchild2.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                ...
                                                ISRvalues_temp.append(ggchild2.text[79:-1])


                            elif child2.tag == "{http://autosar.org/schema/r4.0}PARAMETER-VALUES":
                                for grandchild2 in child2:
                                    if grandchild2.tag == "{http://autosar.org/schema/r4.0}ECUC-TEXTUAL-PARAM-VALUE":
                                        for ggrandchild2 in grandchild2:
                                            if ggrandchild2.tag == "{http://autosar.org/schema/r4.0}SHORT-NAME":
                                                ISRlist_temp.append(ggrandchild2.text)
                                            elif ggrandchild2.tag == "{http://autosar.org/schema/r4.0}VALUE":
                                                ISRvalues_temp.append(ggrandchild2.text)
...
if __name__ == '__main__':
    ...
    alarm1 =  ['RTE_Alarm_alarm1', 'TRUE', 400, '3', '0', 'T1', 'SETEVENT', 'T1', 'RTE_Event_Event2']
    alarm2 =  ['RTE_Alarm_alarm2', 'TRUE', 400, '5', '0', 'T1', 'SETEVENT', 'T1', 'RTE_Event_Event3']
    alarm3 =  ['RTE_Alarm_alarm3', 'TRUE', 400, '7', '1', 'T1', 'SETEVENT', 'T1', 'RTE_Event_Event4']
    alarm4 =  ['RTE_Alarm_alarm4', 'TRUE', 400, '20', '1', 'T2', 'SETEVENT', 'T2', 'RTE_Event_Event7']

    # alarm1 = ["alarm1", "TRUE", 400, 3, "C1", "T1", "FUNCTION_NAME", "T1", "Ev1"]
    # alarm2 = ["alarm2", "FALSE", 250, 2, "C2", "T2", "FUNCTION_NAME", "T2", "Ev2"]
    # alarm3 = ["alarm3", "FALSE", 250, 2, "C2", "T2", "FUNCTION_NAME", "T2", "Ev2"]
    # alarm4 = ["alarm4", "FALSE", 250, 2, "C2", "T2", "FUNCTION_NAME", "T2", "Ev2"]
    ...
    NewXML.AddAlarm(alarm3)
    NewXML.AddAlarm(alarm4)
